    ...
    switch ($act) {
        ...
        case 'sanphamct':
            ...
            if (isset($_GET['id_sanpham']) && ($_GET['id_sanpham'] > 0)) {
                ...
                $sp_tt = loadall_sanpham_mausac_view($id_sanpham);
                $mausac_in_sanpham = load_mausac_in_sanpham($id_sanpham);
            ...
            if (isset($_POST['themgiohang'])) {
                ...
                if (isset($taikhoan['id'])) {
                    ...
                    $check = check_giohang($id_sanpham_mausac, $taikhoan['id']);
                    $tongkho = check_tongkho($id_sanpham_mausac);
                    if (is_array($check)) {
                        ...
                        insert_giohang($id_sanpham_mausac, $soluong, $taikhoan['id']);
                    }
            ...
            if (isset($_POST['dathangngay'])) {
                ...
                $id_sanpham_mausac = $_POST['id_sanpham_mausac'];
                header("Location:index.php?act=thanhtoan&id_sanpham_mausac=$id_sanpham_mausac&soluong=$soluong");
            }
        ...
        case 'thanhtoan':
            ...
            if (isset($_GET['id_sanpham_mausac']) && isset($_GET['soluong'])) {
                $id_sanpham_mausac = $_GET['id_sanpham_mausac'];
                $sptt_muangay = check_gia_ten_mausac_in_sp_tt($id_sanpham_mausac);
                $gia = $sptt_muangay['gia']; //  Để lưu vào dtb bảng đơn hàng chi tiết
                $ten = $sptt_muangay['ten'];  //  Để hiển thị  ở trang checkout (thanh toán)
                $mausac = $sptt_muangay['mausac'];  //  Để hiển thị  ở trang checkout (thanh toán)
                $soluong = $_GET['soluong'];   //  Để lưu vào dtb bảng đơn hàng chi tiết
                $listsanpham = [[
                    'id_sanpham_mausac' => $id_sanpham_mausac,
                    'soluong' => $soluong,
                    'gia' => $gia,
                    'ten' => $ten,
                    'mausac' => $mausac,
            ...
            if (isset($_POST['hoantatdathang'])) {
                ...
                foreach ($listsanpham as $sp) {
                    extract($sp);
                    insert_donhangchitiet($id_donhang, $id_sanpham_mausac, $soluong, $gia);
