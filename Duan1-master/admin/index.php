    ...
    if(isset($_GET['act'])&&($_GET['act']!="")){
        ...
        switch($act){
          ...
          case "danh-sach-bien-the":
            ...
            $listsanpham_mausac = loadall_sanpham_mausac($id_sanpham);
          ...
          case "them-moi-bien-the":
            ...
            if (isset($_POST['themmoi']) && ($_POST['themmoi'])) {
              ...
              if (empty($id_mausac)) {
                $error['id_mausac'] = 'Vui lòng chọn thể tích';
              }
              if (empty($error)) {
                insert_sanpham_mausac($id_sanpham, $id_mausac, $gia, $soluong);
                header("location:index.php?act=danh-sach-bien-the&id_sanpham=$id_sanpham");
              }
            }
            $sanpham =loadone_sanpham($id_sanpham);
            $check_mausac =check_mausac($id_sanpham);
            $listmausac = loadall_mausac();
            include "sanpham/them-moi-bien-the.php";
            break;
          case "sua-bien-the":
            if(isset($_GET['id_bienthe'])&&$_GET['id_bienthe']>0){
              $sanpham_mausac = loadone_sanpham_mausac($_GET['id_bienthe']);
              extract($sanpham_mausac);
            }            
          ...
          case 'cap-nhat-bien-the':
            if(isset($_POST['capnhat'])&&($_POST['capnhat'])){
              extract($_POST);
              update_sanpham_mausac($id,$id_sanpham,$id_mausac,$gia,$soluong);
              header("location:index.php?act=danh-sach-bien-the&id_sanpham=$id_sanpham");
            }
            break; 
          case "xoa-bien-the":
            if(isset($_GET['id_bienthe'])&&($_GET['id_bienthe']>0)){
              delete_sanpham_mausac($_GET['id_bienthe']);
            }
            $id_sanpham = $_GET['id_sanpham'];
            header("location:index.php?act=danh-sach-bien-the&id_sanpham=$id_sanpham");
            break;
          case "khoi-phuc-bien-the":
            if(isset($_GET['id_bienthe'])&&($_GET['id_bienthe']>0)){
              restore_sanpham_mausac($_GET['id_bienthe']);
            }
            $id_sanpham = $_GET['id_sanpham'];
            header("location:index.php?act=danh-sach-bien-the&id_sanpham=$id_sanpham");
            break;
