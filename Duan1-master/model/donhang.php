<?php 
    ...
    function insert_donhangchitiet($id_donhang,$id_sanpham_mausac,$soluong,$gia){
        $sql= "INSERT INTO donhangchitiet(id_donhang,id_sanpham_mausac,soluong,gia)
        VALUES ($id_donhang,$id_sanpham_mausac,$soluong,$gia)";
        pdo_execute($sql); 
    }
    ...
    function loadall_donhangchitiet_admin($id_donhang){
        $sql = "SELECT sanpham.ten ,hinh,mausac,donhangchitiet.soluong,donhangchitiet.gia FROM `donhangchitiet`
        join sanpham_mausac on sanpham_mausac.id=id_sanpham_mausac
