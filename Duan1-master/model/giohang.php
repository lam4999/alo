<?php 
    function loadall_giohang($id){
        $sql = "select id_sanpham_mausac, giohang.id ,hinh,ten,mausac,sanpham_mausac.soluong as conlai ,giohang.soluong,gia from giohang 
        join sanpham_mausac on giohang.id_sanpham_mausac =  sanpham_mausac.id
    ...
    function insert_giohang($id_sanpham_mausac,$soluong,$id_taikhoan){
        $sql= "INSERT INTO giohang(id_sanpham_mausac,soluong,id_taikhoan) 
            VALUES ($id_sanpham_mausac,$soluong,$id_taikhoan)";
        pdo_execute($sql); 
    }
    function check_giohang($id_sanpham_mausac,$id_taikhoan){
        $sql="SELECT * FROM `giohang` 
        WHERE id_sanpham_mausac =$id_sanpham_mausac and id_taikhoan =$id_taikhoan";
