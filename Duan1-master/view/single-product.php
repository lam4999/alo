      ...
      <div class="col-lg-6">
          ...
          <div class="single-product-info product">
            ...
            <div class="d-flex align-items-center mb-30">
              ...
              <?php 
                $i=-1;
                foreach($mausac_in_sanpham as $tt){
                  $i++;
                  $check= $gia==$tt["gia"]?"style='color:orangered;border-color: orangered;'":"";
                  echo '<span class="mausac" onclick="showmausac('.$i.')" '.$check.'>
                        <strong>'.$tt["mausac"].'</strong> <br>
                        <p>'.number_format($tt["gia"],0,",",".").'<u>đ</u></p>
                      </span>
                      <input type="hidden" name="id_sanpham_mausac" value='.$tt["id"].'>'; 
                }
              ?> 
            </div>
            ...
            <div class="product-footer">
                <form action="index.php?act=sanphamct&id_sanpham=<?=$id_sanpham?>" method="post">
                  ...
                  <input type="hidden" name="id_sanpham_mausac" value="<?=$id?>">
...
<script>
  let index= 0;
  function showmausac(index){
    let mausac = document.getElementsByClassName('product');
    for(let i of mausac){
        i.style.display="none";
    }
    mausac[index].style.display="block";
  }
   showmausac(0);
</script>
