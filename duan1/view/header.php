<?php $listCategory = load_category(); 
ob_start();
								...
								<li><span>
									...
									<div id="menu">
										<ul>
											...
											<li><span><a href="#0"><?php echo $list['ten_loai'] ?></a></span>
									...
									<div class="dropdown-menu">
										<ul>
											<?php if(!isset($_SESSION['email'])): ?>
												<li>
													<a href="index.php?act=login" class="btn_1">Sign In or Sign Up</a>
												</li>
											<?php endif; ?>

											<?php if(isset($_SESSION['email']) && $user['vai_tro'] == 'Admin'): ?>
												<li>
													<a href="admin/index.php"><i class="ti-package"></i>My Admin</a>
												</li>
											<?php endif; ?>
												<li>
												...
												<li>
													<a href="model/login.php"><i class="fa-solid fa-right-from-bracket"></i>Log Out</a>
												</li>
